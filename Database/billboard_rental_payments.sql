...
CREATE TABLE `payments` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`billboard_id`) REFERENCES `billboards` (`id`) ON DELETE CASCADE,
...
INSERT INTO `payments` VALUES (1,1,1,1000.00,'2024-10-15 05:36:20');
