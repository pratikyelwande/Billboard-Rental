...
LOCK TABLES `billboard_type` WRITE;
/*!40000 ALTER TABLE `billboard_type` DISABLE KEYS */;
INSERT INTO `billboard_type` VALUES (1,'Digital'),(2,'Analog');
/*!40000 ALTER TABLE `billboard_type` ENABLE KEYS */;
UNLOCK TABLES;
